...
export class CharacterCard extends React.Component{
    ...
    loadCharacter() {
        this.props.dispatch(loadCharacter(this.props.character));
    }    
    ...
    render() {
        ...
        return (
            <div className="characterCard">
                        {/* TODO */}    
                <Link to={ '/playerDemo/character/' + character.name } onClick={this.loadCharacter.bind(this)} ><img src={characterThum.src} alt={characterThum.alt}></img>
